...
const StandardRow = ({
  ...
  // Use only the provided values, do not randomize
  const rgbLiquid = lab2rgb(Number(liquidL), Number(liquidA), Number(liquidB));
  const rgbPanel = lab2rgb(Number(panelL), Number(panelA), Number(panelB));
