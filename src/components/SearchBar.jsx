  ...
  return (
    <div className="relative w-full max-w-xs mb-4">
      ...
      <input
        ...
        className="pl-10 pr-4 py-2 w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-600 transition-colors"
      />
