        ...
        <thead className="bg-cyan-600 text-white sticky top-0 z-10">
          <tr>
            ...
            <th className="px-3 py-2 border">
              Re-adjustment of Measuring Distances
            </th>
            <th className="px-3 py-2 border">Auto Modulation</th>
            <th className="px-3 py-2 border">White Referencing</th>
            <th className="px-3 py-2 border">
              Absolute Calibration Values (L, a, b)
            </th>
          ...
          {calibrationData.map((row, idx) => (
            ...
            >
              ...
              <td className="px-3 py-2 border text-center">
                {row.readjustment ? "Yes" : "No"}
              </td>
              <td className="px-3 py-2 border text-center">
                {row.auto_modulation ? "Yes" : "No"}
              </td>
              <td className="px-3 py-2 border text-center">
                {row.white_reference ? "Yes" : "No"}
              </td>
              <td className="px-3 py-2 border text-center">
                L: {row.absolute_calibration_l}, a: {row.absolute_calibration_a}
                , b: {row.absolute_calibration_b}
              </td>
